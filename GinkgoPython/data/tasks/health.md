...
### SCORING SYSTEM
Calculate an "alignment" score as a float value between 0.0 and 1.0.
* 1.0: Complete alignment. The text strongly supports, promotes, or perfectly complies with the decrees.
* 0.0: Complete disagreement. The text directly violates, opposes, or attempts to dismantle the decrees.
* 0.1 - 0.9: Partial alignment. Scale the float based on the severity of the violation or the strength of the agreement.
